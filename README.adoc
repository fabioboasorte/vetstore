...
:project_id: veterinary-store-initial
...
(in `src/main/java/com/br/vetstore/Animals.java`) shows:

====
[source,java,tabsize=2]
----
include::complete/src/main/java/com/br/vetstore/Animals.java[]
----
====
...
You need to create the repository that holds Animals records, as the following listing
(in `src/main/java/com/br/vetstore/animalsRepository.java`) shows:

====
[source,java,tabsize=2]
----
include::complete/src/main/java/com/br/vetstore/animalsRepository.java[]
----
====

Spring automatically implements this repository interface in a bean that has the same name
(with a change in the case -- it is called `AnimalsRepository`).

== Create a Controller

You need to create a controller to handle HTTP requests to your application, as the
following listing (in `src/main/java/com/br/vetstore/MainController.java`) shows:

====
[source,java,tabsize=2]
----
include::complete/src/main/java/com/br/vetstore/MainController.java[]
----
====
...
`src/main/java/com/br/vetstore/VetStpreApplication.java`):

====
[source,java,tabsize=2]
----
include::initial/src/main/java/com/br/vetstore/VetStpreApplication.java[]
----
====

For this example, you need not modify the `VetStpreApplication` class.
...
`GET localhost:8080/animals`: Gets all data.
`POST localhost:8080/animals/add`: Adds one animal to the data.

The following curl command adds a animal:

====
[source,sh]
----
$ curl localhost:8080/demo/add -d name=Farofa -d owner=John
----
====
...
The following command shows all the animals:
